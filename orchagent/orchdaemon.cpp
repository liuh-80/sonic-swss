...
bool OrchDaemon::init()
{
    ...
    DashVnetOrch *dash_vnet_orch = new DashVnetOrch(m_applDb, *m_zmqServer, dash_vnet_tables);
    ...
    DashOrch *dash_orch = new DashOrch(m_applDb, *m_zmqServer, dash_tables);
    ...
    DashRouteOrch *dash_route_orch = new DashRouteOrch(m_applDb, *m_zmqServer, dash_route_tables, dash_orch);
    ...
    DashAclOrch *dash_acl_orch = new DashAclOrch(m_applDb, *m_zmqServer, dash_acl_tables, dash_orch);
